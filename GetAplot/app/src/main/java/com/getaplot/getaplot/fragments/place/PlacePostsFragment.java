...
adapter=new FirebaseRecyclerAdapter<InfoHive, InfoHiveVH>(options) {
    @Override
    protected void onBindViewHolder(@NonNull final InfoHiveVH viewHolder, int position, @NonNull final InfoHive model) {
    ...
    public InfoHiveVH onCreateViewHolder(ViewGroup parent, int viewType) {
      View v=  LayoutInflater.from(parent.getContext()).inflate(R.layout.single_info_hive,parent,false);
    ...
    public static class InfoHiveVH extends RecyclerView.ViewHolder {
        ...
        public void setHiveTime(long time,Context context) {
            ...
            ev_time.setText(GetTimeAgo.getTimeAgo(time,context));
        }

        public void setEventCover(String cover, Context context) {
            RequestOptions requestOptions = new RequestOptions()
                    .centerCrop()
                    .placeholder(R.drawable.ic_feedd);
            try {
